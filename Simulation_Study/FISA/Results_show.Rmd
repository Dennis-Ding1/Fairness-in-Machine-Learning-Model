...
ggsave("fair_lambda.png", p_fl, width = 12, height = 8, dpi = 300)
```
...
ggsave("perf_lambda.png", p_pl, width = 12, height = 6, dpi = 300)
...
ggsave("perf_model.png", p_pm, width = 12, height = 6, dpi = 300)
...
ggsave("fair_model.png", p_fm, width = 12, height = 8, dpi = 300)
